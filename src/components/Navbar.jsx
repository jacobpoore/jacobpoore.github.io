  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ul className="hidden md:flex space-x-8 items-center" style={{ fontSize: fontSize }}>
            ...
            <li className="relative group">
              ...
              {openTab === "about" && (
                <div
                  ...
                  className="absolute top-full mt-2 bg-white dark:bg-gray-800 shadow-xl dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 grid grid-cols-2 gap-8 z-10 transition-all duration-200 animate-in slide-in-from-top-2"
                  style={{
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 dark:text-white text-base mb-3">Blog</h4>
                      <ul className="space-y-2">
                        {[
                          { href: "/b1", title: "Cars", subtitle: "Modern and vintage automotive" },
                          { href: "/b2", title: "Physics", subtitle: "Technical deep-dives" },
                          { href: "/b3", title: "Hi-Fi", subtitle: "Audio engineering & acoustics" },
                          { href: "/b4", title: "Retro Tech", subtitle: "Legacy systems & achievements" },
                        ].map((item) => (
                          <li key={item.href}>
                            <a
                              href={item.href}
            ...
            <li className="relative group">
              ...
              {openTab === "projects" && (
                <div
                  ...
                  className="absolute top-full mt-2 bg-white dark:bg-gray-800 shadow-xl dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 grid grid-cols-3 gap-6 z-10 transition-all duration-200 animate-in slide-in-from-top-2"
                  style={{
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="border-b border-gray-200 dark:border-gray-700 pb-3">
                      <h3 className="font-semibold text-gray-900 dark:text-white text-lg">CAD Projects</h3>
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
                aria-label="LinkedIn Profile"
              >
                <FaLinkedinIn className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 w-5 h-5 transition-colors duration-200" />
              </a>
            </li>
          </ul>
        </div>
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="md:hidden mt-4 space-y-4 pb-6 border-t border-gray-200 dark:border-gray-700 pt-6 animate-in slide-in-from-top-2">
            <a
              href="/about"
            ...
            <div>
              ...
              {mobileDropdown.projects && (
                <div className="underline ml-4 mt-2 space-y-2 pl-4 border-l-2 border-blue-200 dark:border-blue-800 animate-in slide-in-from-top-1">
                  {[
