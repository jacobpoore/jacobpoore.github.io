...
const Gallery = () => {
  ...
  const images = [
    { id: 1, src: "/placeholder.svg?height=400&width=400", alt: "Gallery Image 1" },
    { id: 2, src: "/placeholder.svg?height=300&width=500", alt: "Gallery Image 2" },
    { id: 3, src: "/placeholder.svg?height=500&width=300", alt: "Gallery Image 3" },
    { id: 4, src: "/placeholder.svg?height=350&width=450", alt: "Gallery Image 4" },
    { id: 5, src: "/placeholder.svg?height=450&width=350", alt: "Gallery Image 5" },
    { id: 6, src: "/placeholder.svg?height=400&width=400", alt: "Gallery Image 6" },
  ]
